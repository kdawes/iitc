...
// @updateURL      https://raw.github.com/shottrue/iitc/gh-pages/plugins/compute-ap-stats.user.js
// @downloadURL    https://raw.github.com/shottrue/iitc/gh-pages/plugins/compute-ap-stats.user.js
...
window.plugin.compAPStats.onPositionMove = function() {
  ...
  $('#available_ap_display').html('Available AP in this area:<table>'
    + '<tr><td>Enlightened:</td><td style="text-align:right">' + digits(result[1]) + '</td><td style="text-align:right"> from ' + digits(result[2]) + ' Portals</td></tr>'
    + '<tr><td>Resistance:</td><td style="text-align:right">' + digits(result[0]) + '</td><td style="text-align:right"> from ' + digits(result[3]) + ' Portals</td></tr>'
    + '<tr><td>Neutral:</td><td style="text-align:right"></td><td style="text-align:right">' + digits(result[4]) + ' Portals</td></tr>'
    + '</table>');
}
...
window.plugin.compAPStats.compAPStats = function() {
  ...
  var totalAP_RES = 0;
  var totalAP_ENL = 0;
  var totalPortals_RES = 0;
  var totalPortals_ENL = 0;
  var totalPortals_NEU = 0;
  ...
  return [totalAP_RES, totalAP_ENL, totalPortals_RES, totalPortals_ENL, totalPortals_NEU];
}
